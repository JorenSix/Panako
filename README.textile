...
Panako uses the "Gradle":https://gradle.org/ build system. Install it on your system. Once ant and the other components are installed correctly the following commands should get you started:
